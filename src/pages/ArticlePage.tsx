            ...
            <div className="bg-card shadow-elegant rounded-lg p-8 md:p-12 mb-12 animate-fade-in-up">
              ...
              <div 
                className="font-article prose max-w-none
                  ...
                  [&_blockquote_p]:mb-0
                  [&_ul]:my-4 [&_ul]:space-y-1.5 [&_ul]:text-base md:[&_ul]:text-lg [&_ul]:pl-5
                  [&_ol]:my-4 [&_ol]:space-y-1.5 [&_ol]:text-base md:[&_ol]:text-lg [&_ol]:pl-5
                  [&_li]:text-foreground/90 [&_li]:leading-relaxed
                  [&_hr]:my-6 md:[&_hr]:my-7 [&_hr]:border-border
